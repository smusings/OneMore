...
public class FragmentOne extends Fragment{
    ...
    public static final String PREF_COUNT_1 = "MyPrefsCount4";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        itemLabel_et = (EditText) getView().findViewById(R.id.item_label_text);
        itemCount_tv = (TextView) getView().findViewById(R.id.item_count_text);
        SharedPreferences pref = getActivity().getSharedPreferences(PREF_COUNT_1, 0);
