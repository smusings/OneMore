...
class OneMoreArrayAdapter extends ArrayAdapter<String> {
    ...
    private int[] colors = new int[]{R.color.DarkCyan, R.color.DarkOrange, R.color.ForestGreen};

    public OneMoreArrayAdapter(Context context, ArrayList<String> list, ArrayList<String> amount) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.one_more_list, parent, false);
